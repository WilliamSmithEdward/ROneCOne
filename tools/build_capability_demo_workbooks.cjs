...
const capabilities = [
  ...
  },
  {
    ...
    examples: [
      ...
      ["Cooperative delay", "await Task.Delay(5)", "ROneCOne.Task.Delay(5&).Wait(100&)", true],
      ["Wait for all", "await Task.WhenAll(tasks)", "ROneCOne.Task.WhenAll(tasks).Await.JoinText(\",\")", "10,20"],
  ...
  },
  {
    ...
    examples: [
      ["Typed schema", "DataColumn.AutoIncrement", "table.Column(\"Id\", vbLong).AutoNumber(100&, 10&)", 100],
